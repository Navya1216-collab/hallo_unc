...
def save_tensor_as_image(tensor, filename):
    ...
    :param filename: The file name for the saved image.
    """
    # Move tensor to CPU, detach, and convert to numpy
    ...
    image_np = image_np.astype(np.uint8)  # Convert to uint8 for image saving
...
class FaceAnimatePipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        # print("here", self.ref_image_processor.shape)
    @property
